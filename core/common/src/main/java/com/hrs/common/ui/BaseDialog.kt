...
abstract class BaseDialog<VB : ViewBinding> constructor(
    ...
    open fun onResizeWindowSizeChanged(oldWidth: Int, oldHeight: Int, newWidth: Int, newHeight: Int): Size{
